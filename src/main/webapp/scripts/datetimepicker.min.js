/*
 * datetimepicker.min.jsp
 *
 * Changes Copyright (C) 2013 Universidad de Sevilla
 *
 * The use of this project is hereby constrained to the conditions of the
 * TDG Licence, a copy of which you may download from
 * http://www.tdg-seville.info/License.html
 *
 * Changes are indicated with RC+ and RC- labels
 * 	- Left offset is now computed correctly when the date-time picker is within a container
 * 	- The picker doesn't pop up when the associated control is read-only
 */
		...
		place: function(){
			...
			if (this.component) {
				...
				if (this.pickerPosition == 'bottom-left' || this.pickerPosition == 'top-left') {
					...
					// RC-
					// RC+
					left += this.component.outerWidth() - this.picker.outerWidth() - containerOffset;
					// RC+					
				} 
                // RC+
                else {
