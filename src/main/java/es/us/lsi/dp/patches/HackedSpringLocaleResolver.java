 ...
 */
public class HackedSpringLocaleResolver extends DefaultLocaleResolver {

	@Override
	public Locale resolveLocale(final Request request) {
		try {
		...
		} catch (final NotAServletEnvironmentException e) {
			// Ignore
		}
