		...
		for (int i = 0; i < iDimension; i++) {
			...
			for (int j = 0; j < jDimension - 1; j++) {
				...
				if (column.getFormat() != null && column.getFormat().equals("image")) {
					...
					String codeNumberFormat;
					String prefix;
					String suffix;
					Locale local;
					local = LocaleContextHolder.getLocale();
					
					decimalMark = (column.getOutFormat() != null ? column.getOutFormat()+".":"")+ "currency.decimal-mark";
					groupingSeparator = (column.getOutFormat() != null ? column.getOutFormat()+".":"")+ "currency.grouping-separator";
					codeNumberFormat = (column.getOutFormat() != null ? column.getOutFormat()+".":"")+ "currency.number-format";
					prefix = (column.getOutFormat() != null ? column.getOutFormat()+".":"")+ "currency.prefix";
					suffix = (column.getOutFormat() != null ? column.getOutFormat()+".":"")+ "currency.suffix";
					
					decimalMark = messageSource.getMessage(decimalMark, null, local);
					groupingSeparator = messageSource.getMessage(groupingSeparator, null, local);
					codeNumberFormat = messageSource.getMessage(codeNumberFormat, null, local);
					prefix = messageSource.getMessage(prefix, null, local);
					suffix = messageSource.getMessage(suffix, null, local);
					...
					DecimalFormat numberFormat = new DecimalFormat(codeNumberFormat, decimalFormatSymbols);
				...
				} else if (column.getFormat() != null && column.getFormat().equals("decimal")) {
					String decimalMark;
					String groupingSeparator;
					String codeNumberFormat;
					Locale local;
					...
					decimalMark = (column.getOutFormat() != null ? column.getOutFormat()+".":"")+ "decimal-mark";
					groupingSeparator = (column.getOutFormat() != null ? column.getOutFormat()+".":"")+ "grouping-separator";
					codeNumberFormat = (column.getOutFormat() != null ? column.getOutFormat()+".":"")+ "number-format";
